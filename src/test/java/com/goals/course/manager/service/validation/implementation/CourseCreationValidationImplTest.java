...
class CourseCreationValidationImplTest {
    ...
    void validateCreation_passed_callValidate() {
        ...
        // WHEN
        new CourseCreationValidationImpl(validations).validateCreation(courseDTO);
    ...
    void validateCreation_passed_checkResult() {
        ...
        // WHEN
        final var result = new CourseCreationValidationImpl(validations).validateCreation(courseDTO);
